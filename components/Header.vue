<template>
    <div class="bg-[#000837] max-w-screen py-5">
        <div class="flex items-center justify-center mb-5 md:mb-0">
            <img class="md:w-32 w-16" src="https://save-effort.netlify.app/_nuxt/logo.6ece8b48.svg"/>
        ...
        <section class="col-span-4">
            <img src="https://save-effort.netlify.app/_nuxt/left.e8deac14.svg" class="w-full" alt="one"/>
        </section>
        <section class="col-span-4">
            <div class="flex flex-col justify-center">
                <img src="https://save-effort.netlify.app/_nuxt/arrow.f2fd64d8.webp" class="w-full md:mt-5"/>
        ...
        <section class="col-span-4">
            <img src="https://save-effort.netlify.app/_nuxt/right.99cac913.svg" class="w-full" alt="two"/>
        </section>
    </div>
    <div class="mt-5 md:mt-0">
        <h3 class="text-center text-white text-2xl md:text-4xl font-bold">
            Operate Business like Zomato i.e. Automated & Scalable
        </h3>
    </div>
